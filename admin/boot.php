<?php
	...
	function wbcr_ga_group_options($options)
	{
		...
		$options[] = array(
			...
			'title' => __('Enable hidden notices in adminbar', 'google-analytics-cache'),
			'tags' => array()
		);
	...
	function wbcr_ga_set_plugin_meta($links, $file)
	{
		if( $file == WGA_PLUGIN_BASE ) {
			$links[] = '<a href="https://goo.gl/TcMcS4" style="color: #FF5722;font-weight: bold;" target="_blank">' . __('Get ultimate plugin free', 'google-analytics-cache') . '</a>';
		}
